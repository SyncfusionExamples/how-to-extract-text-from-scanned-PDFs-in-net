# How to Extract Text from Scanned PDFs in .NET using the Syncfusion OCR Library

## Introduction
A quick start .NET console project that shows how to extract text from scanned PDFs using the Syncfusion OCR Library.
...
We will create a new .NET console application, add the Syncfusion OCR library package, and write the code
